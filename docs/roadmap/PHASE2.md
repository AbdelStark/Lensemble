...
| [#204](https://github.com/AbdelStark/Lensemble/issues/204) | Evidence bundle and model card | Published at checkpoint repo revision `eaf13136b42cde324758a191c98e377636ded7f8` with generated bundle and model card. |
...
## Published Phase 2 Evidence Bundle And Model Card

The final evidence bundle is generated by `scripts/phase2_bundle.py` from local
copies of the published data, training, downstream, and curves reports. The
script performs Hub existence checks for:

- `phase2_dataset_smoke.json`, `phase2_silo_manifest.json`, and both published
  silo HDF5 files in
  `abdelstark/lensemble-phase2-so100-silos@97336927606fea6fbfda308bb7cee6e7b48999fa`;
- `claim_mvp_report.json` and `artifacts/round-00003/header.json` in
  `abdelstark/lensemble-phase2-so100-checkpoint@da52ef380ac87317c89e87f048d65bae65c16b9e`;
- `reports/phase2_downstream_eval_report.json` at model revision
  `021a461eb789700209fcb49e99bb9bcc5d84bfe5`;
- `reports/phase2_baselines_curves_report.json` at model revision
  `8643d9f60eeb997afd5b254d525a145769d59c68`.

Checked-in outputs:

- [`docs/evidence/phase2_evidence_bundle.json`](../evidence/phase2_evidence_bundle.json);
- [`docs/evidence/phase2_model_card.md`](../evidence/phase2_model_card.md).

Published checkpoint repo outputs at
[`abdelstark/lensemble-phase2-so100-checkpoint`](https://huggingface.co/abdelstark/lensemble-phase2-so100-checkpoint)
revision `eaf13136b42cde324758a191c98e377636ded7f8`:

- `README.md`;
- `reports/phase2_evidence_bundle.json`;
- `reports/phase2_model_card.md`;
- `reports/phase2_baselines_curves_report.json`.

The downloaded-back verification matched local hashes:

| Artifact | SHA-256 |
|---|---|
| `phase2_evidence_bundle.json` | `0c1bd8a7f1737cf336cbc1139cc75a8ced3a1dae603f6f8a5c9573b345f272ea` |
| `phase2_model_card.md` / `README.md` | `07dd882299960a42079a42eae237aa3ca2cbf97e80aa09b1a3500961fbbb1a29` |
| `phase2_baselines_curves_report.json` | `764f5aab86df18c3c6226dae0e07e9e95bc05e385bd40fa5897a88cb6da412dd` |
