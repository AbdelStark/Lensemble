...
| Sovereign-economy stage card | The Codex-Paris economy gate renders a simulated EUR 1,000,000 buyer sale, EUR 200,000 orchestrator share, EUR 800,000 community pool, contribution-weighted participant rewards, mock or server-side Mollie test checkout status, and the same +12.3% / +16.8% / +5.4% model-quality proof. Rewards are simulation-only, not legal payouts or securities. | `scripts/hackathon_demo_rehearsal.py`, [sovereign-economy runsheet](../plans/hackathons/codex-hackathon-paris-june/sovereign-economy/04-demo-runsheet.md), `web/federated-demo/app.mjs` |
...
uv run python scripts/hackathon_demo_rehearsal.py # integrated sovereign-economy rehearsal
