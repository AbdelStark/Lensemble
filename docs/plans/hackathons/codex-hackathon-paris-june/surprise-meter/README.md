# Surprise-meter (#338) — PRIORITY plan

The primary Codex-hackathon deliverable: a clean federated **adapter-continuation** run on the frozen LeWM world model, then a live **surprise-meter** showing the model is measurably *less surprised* after the room trains it together.
