...
The hackathon is active. Read [`TODAY.md`](TODAY.md), then execute the `#338`
queue without re-planning:

1. [#349](https://github.com/AbdelStark/Lensemble/issues/349) - clean
   federated adapter-continuation round. This is the first build target and the
   standalone fallback demo.
2. [#350](https://github.com/AbdelStark/Lensemble/issues/350) and
   [#351](https://github.com/AbdelStark/Lensemble/issues/351) - scalar surprise
   engine and the live meter.
3. [#352](https://github.com/AbdelStark/Lensemble/issues/352),
   [#353](https://github.com/AbdelStark/Lensemble/issues/353), and
   [#354](https://github.com/AbdelStark/Lensemble/issues/354) - pre/post
   toggle, evidence, rehearsal, fallback, and capture.

Do not start [#339 Cartographer](https://github.com/AbdelStark/Lensemble/issues/339)
until `#338` is rehearsal-green with fallback assets on disk.
...
- [`surprise-meter/`](surprise-meter/) — **the priority plan** (#338 + the Milestone-0 clean adapter-continuation round). Read this first.
